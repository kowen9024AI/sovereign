...
| [`WO-SOVEREIGN-SSCM-01B`](WO-SOVEREIGN-SSCM-01B.md) | `SOVEREIGN_SSCM_PARALLEL_FANOUT_FANIN_QUALIFIED` — [report](WO-SOVEREIGN-SSCM-01B-REPORT.md); R1 `SOVEREIGN_SSCM_PARALLEL_R1_READY` — [report](WO-SOVEREIGN-SSCM-01B-R1-REPORT.md) |
| [`WO-SOVEREIGN-SSCM-01C`](WO-SOVEREIGN-SSCM-01C.md) | `SOVEREIGN_SSCM_BOUNDED_REPAIR_EVALUATION_QUALIFIED` — [report](WO-SOVEREIGN-SSCM-01C-REPORT.md) |
